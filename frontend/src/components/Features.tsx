...
const features = [
  ...
  },
  {
    ...
    title: "Qualité 4K",
    desc: "Support natif jusqu'à 2160p pour une clarté cristalline.",
  },
  {
        ...
        {features.map((item, index) => (
          ...
          >
            <GlareCard className="flex flex-col items-center justify-center p-6 text-center">
              ...
              <div className="w-14 h-14 rounded-full bg-neutral-800/80 flex items-center justify-center mb-6 shadow-lg shadow-purple-500/20 backdrop-blur-sm">
                {item.icon}
              </div>
